...
namespace NopCommerce.Api.AdapterLibrary
{
    public class ApiAuthorizer
    {
        ...
        public string GetAuthorizationUrl(string redirectUrl, string[] scope, string state = null)
        {
            ...
            stringBuilder.AppendFormat("?client_id={0}", WebUtility.UrlEncode(_clientId));
            stringBuilder.AppendFormat("&redirect_uri={0}", WebUtility.UrlEncode(redirectUrl));
            ...
            if (scope != null && scope.Length > 0)
            {
                ...
                stringBuilder.AppendFormat("&scope={0}", WebUtility.UrlEncode(scopeJoined));
            }
